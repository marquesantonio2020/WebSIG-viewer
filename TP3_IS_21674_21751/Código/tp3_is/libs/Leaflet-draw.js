    ...
    L.drawVersion = "0.4.2", L.Draw = {}, L.drawLocal = {
        draw: {
            toolbar: {
                ...
                undo: {
                    title: "Eliminar ultimo ponto",
                    text: "Eliminar ultimo ponto"
                },
                buttons: {
                    polyline: "Desenha uma Linha",
                    polygon: "Desenha um pologono",
                    rectangle: "Desenhar um retangulo",
                    circle: "Desenhar um circulo",
                    marker: "Colocar um marco"
                }
            },
            handlers: {
                circle: {
                    tooltip: {
                        start: "Clique para desenhar um circulo."
                    },
                    radius: "Raio"
                },
                marker: {
                    tooltip: {
                        start: "Clique para colocar um marco."
                    }
                },
                polygon: {
                    tooltip: {
                        start: "Clique para iniciar o desenho do poligono.",
                        cont: "Clique para adicionar um novo nó.",
                        end: "Clique no botão terminar para terminar o desenho."
                    }
                },
                polyline: {
                    error: "<strong>Error:</strong> shape edges cannot cross!",
                    tooltip: {
                        start: "Clique para iniciar o desenho da linha.",
                        cont: "Clique para adicionar um novo nó na linha.",
                        end: "Clique no último nó para terminar a linha."
                    }
                },
                rectangle: {
                    tooltip: {
                        start: "Clique e arraste para desenhar o retangulo"
                    }
                },
                simpleshape: {
                    tooltip: {
                        end: "Deixe de clicar para terminar o desenho."
                    }
                }
            }
        },
